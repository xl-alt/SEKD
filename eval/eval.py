...
if __name__ == '__main__':
    ...
    parser.add_argument('--datadir', default="/VOC2012")
    parser.add_argument('--distillation-type',default='sekd',choices=['teacher','student','sekd'])
