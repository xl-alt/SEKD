...
class GMLP_Encoder(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, gate_layer=nn.Sigmoid,
                 drop=0.):
        super().__init__()
        ...
        self.dwconv = DWConv(hidden_features)  # ������ȿɷ�����
...
class GMLP_Decoder(nn.Module):
    def __init__(self, input_dim=512, embed_dim=768, bottleneck_dim=256, act_layer=nn.ReLU, gate_layer=nn.Sigmoid,
                 drop=0.):
        super().__init__()
        # ʹ��ƿ������ٲ�����
...
class Block(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp = GMLP_Encoder(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
...
class MixVisionTransformer(nn.Module):
    def __init__(self, img_size=512, patch_size=16, in_chans=3, num_classes=3, embed_dims=[64, 128, 256, 512],
        ...
        self.linear_c4 = GMLP_Decoder(input_dim=embed_dims[3], embed_dim=decoderembed_dim)
        self.linear_c3 = GMLP_Decoder(input_dim=embed_dims[2], embed_dim=decoderembed_dim)
        self.linear_c2 = GMLP_Decoder(input_dim=embed_dims[1], embed_dim=decoderembed_dim)
        self.linear_c1 = GMLP_Decoder(input_dim=embed_dims[0], embed_dim=decoderembed_dim)
