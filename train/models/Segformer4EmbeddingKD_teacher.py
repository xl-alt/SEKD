...
if __name__ == "__main__":
    model = mit_b0(num_classes=8, phi="b4", pretrained=False)
    input_tensor = torch.randn(2, 3, 512, 512)  # 创建测试输入
    _,output, _ = model(input_tensor)  # 前向传播
    print("输入大小:", input_tensor.shape)
    print("输出大小:", output)
# if __name__ == "__main__":
#     model = mit_x1(num_classes=3, phi="b0",  pretrained = False)
